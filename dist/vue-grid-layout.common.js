/*! vue-grid-layout - 2.4.0 | (c) 2015, 2024  Gustavo Santos (JBay Solutions) <gustavo.santos@jbaysolutions.com> (http://www.jbaysolutions.com) | https://github.com/jbaysolutions/vue-grid-layout */
module.exports =
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7cec08b2-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/GridLayout.vue?vue&type=template&id=5d94914b&
...
// CONCATENATED MODULE: ./src/components/GridLayout.vue?vue&type=template&id=5d94914b&
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      this.$nextTick(function () {
        ...
        var newLayout = Object(utils["c" /* compact */])(Object(utils["b" /* cloneLayout */])(self.layout), self.verticalCompact);
  ...
  methods: {
    layoutUpdate: function layoutUpdate() {
      if (this.layout !== undefined && this.originalLayout !== null) {
        ...
        var newLayout = Object(utils["c" /* compact */])(Object(utils["b" /* cloneLayout */])(this.layout), this.verticalCompact);
    ...
    dragEvent: function dragEvent(eventName, id, x, y, h, w) {
      ...
      var newLayout = Object(utils["g" /* moveElement */])(Object(utils["b" /* cloneLayout */])(this.layout), l, x, y, true, this.preventCollision);
      if (this.restoreOnDrag) {
        // Do not compact items more than in layout before drag
        // Set moved item as static to avoid to compact it
        l.static = true;
        Object(utils["c" /* compact */])(newLayout, this.verticalCompact, this.positionsBeforeDrag);
        l.static = false;
      } else {
        Object(utils["c" /* compact */])(newLayout, this.verticalCompact);
      }
      this.$emit('update:layout', newLayout);
...
function findOrGenerateResponsiveLayout(orgLayout /*: Layout*/, layouts /*: ResponsiveLayout*/, breakpoints /*: Breakpoints*/, breakpoint /*: Breakpoint*/, lastBreakpoint /*: Breakpoint*/, cols /*: number*/, verticalCompact /*: boolean*/) /*: Layout*/ {
  ...
  if (layouts[breakpoint]) return Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* cloneLayout */ "b"])(layouts[breakpoint]);
